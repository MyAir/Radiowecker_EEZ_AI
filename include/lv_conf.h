...
/*Swap the 2 bytes of RGB565 color. Useful if the display has a different endianness than the MCU.*/
...
/*Set LVGL to use ESP-IDF's memory management capabilities, including PSRAM*/
#define LV_USE_ESP_IDF 1
#if LV_USE_ESP_IDF
    #define LV_ESP_IDF_MEM_ALLOC_MODE LV_ESP_IDF_MEM_ALLOC_MODE_SPIRAM
#endif
