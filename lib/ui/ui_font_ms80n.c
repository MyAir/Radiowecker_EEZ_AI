 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --bpp 4 --size 80 --no-compress --font Montserrat-Medium.ttf --symbols 0123456789: --format lvgl
 ******************************************************************************/
...
#ifndef UI_FONT_MS80N
#define UI_FONT_MS80N 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_ms80n = {
#else
lv_font_t ui_font_ms80n = {
#endif
